...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="content">
            ...
            %>
            <br><br>
            Vendedor: <%=v.getVendedor().getNome_RazaoSocial()%>
                ...
                <tbody>
                    ...
                    %>        
                        <tr>
                            ...
                            <td><%=vp.getQuantidadeVendido()%></td>
                            <td>R$ <%=vp.getValorVendido()%></td>
                            <td>R$ <%=vp.getQuantidadeVendido()*vp.getValorVendido()%></td>
                            <td align="center">
                        ...
                        <%
                            total = total + (vp.getQuantidadeVendido()*vp.getValorVendido());
                            cont++;
                        }
