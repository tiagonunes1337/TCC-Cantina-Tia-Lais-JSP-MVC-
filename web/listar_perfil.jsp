                ...
                <tbody>
                    <c:forEach var="p" items="${listarTodos}">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="gerenciar_perfil.do?acao=alterar&idPerfil=${p.idPerfil}">
                                ...
                                <a href="gerenciar_menu_perfil.do?acao=gerenciar&idPerfil=${p.idPerfil}" class="btn-link">
