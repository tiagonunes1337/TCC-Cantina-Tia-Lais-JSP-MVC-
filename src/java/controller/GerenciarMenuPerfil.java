            ...
            if(acao.equals("gerenciar")){
                if(GerenciarLogin.verificarPermissao(request, response)){
                    try{
                        ...
                        exibirMensagem("idPerfil Inválido",false,"", response);
                    }
                }else{
                ...
                if(GerenciarLogin.verificarPermissao(request, response)){
                    ...
                    try{
                        if(idMenuStr.equals("")||idMenuStr.isEmpty())
                            exibirMensagem("O menu deve der selecionado",false,"", response);
                        else{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(idMenuStr.equals("")||idMenuStr.isEmpty()||idPerfilStr.equals("")||idPerfilStr.isEmpty()){
                exibirMensagem("Campos obrigatórios deverão ser preenchidos preenchidos",false,"", response);
            }else{
